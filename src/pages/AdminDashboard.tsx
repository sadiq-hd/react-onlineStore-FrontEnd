...
import { 
    Search, Package, Users, Archive, Loader2 
} from 'lucide-react';
    ...
    return (
        <div className="p-6 bg-gray-50 min-h-screen" dir="rtl">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                ...
                <div className="bg-white rounded-lg shadow">
                    <div className="p-6 border-b">
                        <h2 className="text-xl font-semibold text-purple-600">المنتجات الأكثر مبيع</h2>
                                                 </div>
                    <div className="p-6">
                        <div className="h-80">
                            <ResponsiveContainer width="100%" height="100%">
                    ...
                    <div className="flex items-center">
                        ...
                        <div className="mr-4">
                            ...
                            <h3 className="text-2xl font-bold text-green-600">
                                {formatCurrency(profitCalculations.totalProfit)}
                            </h3>
                            {profitCalculations.grossMargin && (
                                <p className="text-sm text-gray-500">
                                    هامش الربح: {profitCalculations.grossMargin.toFixed(1)}%
                                </p>
                            )}
                        </div>
                    </div>
                ...
                <div className="bg-white rounded-lg shadow p-6">
                    <div className="flex items-center">
                        ...
                        <div className="mr-4">
                            ...
                            <h3 className="text-2xl font-bold text-green-600">
                                {formatCurrency(profitCalculations.netProfit)}
                            </h3>
                            {profitCalculations.profitMargin && (
                                <p className="text-sm text-gray-500">
                                    هامش الربح الصافي: {profitCalculations.profitMargin.toFixed(1)}%
                                </p>
                            )}
                        </div>
                    </div>
