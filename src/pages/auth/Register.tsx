...
const Register: React.FC = () => {
  ...
  // مكون شاشة التحقق من رقم الهاتف
  const renderPhoneVerification = () => {
    return (
      <div className="space-y-5">
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6 text-center">
          <p className="text-sm text-blue-800 mb-2">تم إنشاء الحساب بنجاح! الآن قم بالتحقق من رقم هاتفك</p>
          {testOtp && (
    ...
    <div className="max-w-md w-full bg-white p-8 rounded-xl shadow-md border border-gray-200">
      <div className="text-center">
        ...
        <h2 className="text-2xl font-bold text-gray-800 mb-2">
          {requirePhoneVerification ? 'التحقق من رقم الهاتف' : 'إنشاء حساب جديد'}
        </h2>
        {!requirePhoneVerification && (
          <p className="text-sm text-gray-600 mb-6">
            لديك حساب بالفعل؟{' '}
            <a href="/signin" className="font-medium text-indigo-600 hover:text-indigo-500 transition-colors duration-300">
              تسجيل الدخول
            </a>
          </p>
        )}
      ...
      {requirePhoneVerification ? renderPhoneVerification() : renderRegistrationForm()}
