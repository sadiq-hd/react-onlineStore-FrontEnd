      ...
      <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="hidden md:flex items-center justify-center flex-1">
            <div className="flex space-x-8 space-x-reverse">
              ...
              <Link 
                to="/categories"
                className={`text-white text-base font-medium transition-all duration-300 border-b-2 
                          ${isActive('/categories') ? 'border-white' : 'border-transparent hover:border-white/50'} 
                          py-2 px-1`}
              >
                التصنيفات
              </Link>
        ...
        {isMenuOpen && (
          <div className="md:hidden py-3 border-t border-blue-400">
            ...
            <Link to="/categories" className="block py-2.5 text-white text-center hover:bg-blue-500">التصنيفات</Link>
            ...
            <Link to="/profile" className="block py-2.5 text-white text-center hover:bg-blue-500">حسابي</Link>
