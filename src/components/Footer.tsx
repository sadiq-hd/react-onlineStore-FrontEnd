          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap gap-4">
              {['mada', 'googlepay', 'stcpay', 'applepay', 'pay' , 'SamsungPay'].map((pay) => (
                <img key={pay} src={`/src/assets/${pay}.${pay === 'applepay' ? 'png' : pay === 'pay' ? 'webp' : 'svg'}`} alt={pay} className="w-16 h-16 object-contain bg-white p-2 rounded-lg transition-transform hover:scale-110" />
              ))}
            </div>
          </div>
